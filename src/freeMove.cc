...
FreeMove::FreeMove(float speed, float speedMod, Uint8 speedModKey, Uint8 forward, Uint8 backward, Uint8 right, Uint8 left)
...
void FreeMove::move(glm::vec3 direction, float amount)
{
