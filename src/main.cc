...
public:
  ...
  void init() override
  {
    ...
    GameObject* dirLight2 = (new GameObject())
      ->addComponent(new DirectionalLight(glm::vec3(0.4f, 0.4f, 0), 2.5f));
    addToScene(dirLight2);

    Transform* transformDirLight2 = new Transform();
    transformDirLight2->rotate(toRad(90), glm::vec3(0,1,0));
    ...
    transformDirLight3->rotate(toRad(180), glm::vec3(0,1,0));
    ...
    transformDirLight4->rotate(toRad(270), glm::vec3(0,1,0));
    ...
    addToScene((new GameObject(glm::vec3(0, 3, 0)))
    	       ->addComponent(new MeshRenderer(new Mesh("sphere2.obj"), 
    					       new Material(new Texture("bricks3.jpg"), 
    							    new Texture("bricks3_normal.jpg"), 
    							    glm::vec3(1,1,1), 2 , 1)))
    	       ->addComponent(new PhysicsComponent(glm::vec3(-0.025f,-0.025f, 0), 1.0f, new BoundingSphere(glm::vec3(0,3,0), 1))));
    ...
    addToScene((new GameObject(glm::vec3(4, 1, 0)))
    	       ->addComponent(new MeshRenderer(new Mesh("sphere2.obj"), 
    					       new Material(new Texture("bricks3.jpg"), 
    							    new Texture("bricks3_normal.jpg"), 
    							    glm::vec3(1,1,1), 2 , 1)))
    	       ->addComponent(new PhysicsComponent(glm::vec3(-0.001f, 0.001f, 0), 1.0f, new BoundingSphere(glm::vec3(4,1,0), 1))));

    addToScene((new GameObject(glm::vec3(6, 1, 0)))
    	       ->addComponent(new MeshRenderer(new Mesh("sphere2.obj"), 
    					       new Material(new Texture("bricks3.jpg"), 
    							    new Texture("bricks3_normal.jpg"), 
    							    glm::vec3(1,1,1), 2 , 1)))
    	       ->addComponent(new PhysicsComponent(glm::vec3(-0.0025f, 0, 0), 1.0f, new BoundingSphere(glm::vec3(5,1,0), 1))));

    addToScene((new GameObject(glm::vec3(-2, 2, 0)))
    	       ->addComponent(new MeshRenderer(new Mesh("sphere2.obj"), 
    					       new Material(new Texture("default.jpg"), 
    							    new Texture("default_normal.jpg"), 
    							    glm::vec3(0.5f,1,1), 7, 10)))
    	       ->addComponent(new PhysicsComponent(glm::vec3(0.001f, 0, 0), 10.0f, new BoundingSphere(glm::vec3(-2,2,0), 1))));
